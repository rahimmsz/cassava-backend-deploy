...
export const createPetani = async (req, res) => {
    try {
        ...
        const { lokasilahan, luaslahan, statuskepemilikanlahan, periodeTanamMulai, periodeTanamSelesai, varietassingkong, estimasiproduksi, produksiaktual, catatantambahan, jenispupuk, jumlahpupuk, hargajual, totalpendapatan, pendapatanbersih } = req.body;
